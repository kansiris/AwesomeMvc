...
namespace Omu.Awem.Helpers
{
    ...
    public class GridModCfg
    {
        ...
        public GridModCfg(AweInfo gridAwe)
        {
            awe = gridAwe;
        }
        ...
        /// <returns></returns>
        public GridModCfg InlineEdit(string createUrl, string editUrl, bool oneRow = false, bool reloadOnSave = false, bool rowClickEdit = false)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public GridModCfg MovableRows(Action<MovableRowsCfg> o)
        {
