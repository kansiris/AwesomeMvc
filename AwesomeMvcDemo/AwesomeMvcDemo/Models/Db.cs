...
namespace AwesomeMvcDemo.Models
{
    public static class Db
    {
        ...
        static Db()
        {
            ...
            var ppl = new[]{
                "James", "Jeremy", "Richard", "Penny", "Sheldon", "Leonard", "Zazzles", "Amy", "Howard", "Rajesh", "Robert", "Phil", "Scott",
                "Bernadette", "Russell","Timmy","Jeff","Adam","Jennifer","Audrey","Claudia","Brenda", "Tracy","Allison","Tom","Jerry","Oliver",
                "Justin", "Jamie", "Tania", "Chiren", "Reese", "Dean", "Ian", "Paul", "Gabrielle", "Michelle","Hillary", "Jason","Joshua","Benjamin",
                "Ryan", "Henry", "Lucas", "Maurice", "Jake", "Luke", "Lewis", "Tyler", "David", "Patrick", "Evan", "Sam", "Sebastian", "Ben",
                ...
                "Ruby", "Hannah", "Michael", "Gwen", "Morgan", "Carter", "Dolores", "Earl", "Francesco", "Fabiano", "Fernando",
